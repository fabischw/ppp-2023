...
def myFunc(memory: list[int]) -> int:
...
def myFunc2(*args) -> tuple[list[str], list[str]]:
    result1 = [e for e in args if e.isdigit()]
    result2 = [e for e in args if len(e) == 1]
    return result1, result2

# Test 1
assert myFunc2("nodigit", "d", "1", "23") == (["1", "23"], ["d", "1"])
# Test 2
assert myFunc2("a", "b", "cd") == ([], ["a", "b"])
# Test 3
assert myFunc2("2345", "5.5", "12") == (["2345", "12"], [])
