...
#test1
result1, result2 = lists("1", "hello", "13", "r")
print(f"Numbers:  {result1}")
print(f"one character: {result2}")
        
#test2
result1, result2 = lists("0", "u","variable", "12345","32","5e-09")
print(f"Numbers:  {result1}")
print(f"one character: {result2}")
        
#test3
result1, result2 = lists("ts", "098","1.23", "h","-32","1","f")
print(f"Numbers:  {result1}")
print(f"one character: {result2}")
