...
result = process_intcode(commands)
print(result)
...
input_list = input("Geben Sie eine Liste von Strings ein (getrennt durch Leerzeichen): ").split()

number_list, char_list = categorize_strings(*input_list)

print("Zahlen:", number_list)
print("Ein-Zeichen-Strings:", char_list)
